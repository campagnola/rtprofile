...
from .profiler import Profile, CallRecord, ProfileAnalyzer, TreeDisplayData, ThreadDisplayData, FunctionAnalysis
from .code_editor import invoke_code_editor
    ...
    def _onCallTreeDoubleClicked(self, item, column):
        ...
        if isinstance(item, LazyCallItem):
            ...
            if calling_location:
                ...
                try:
                    invoke_code_editor(filename, line_number)
